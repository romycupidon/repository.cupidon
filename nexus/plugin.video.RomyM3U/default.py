...
myaddon = xbmcaddon.Addon("plugin.video.RomyM3U")
#px={"http": "http://14.139.189.213:3128"}
px=''
local_file=xbmcvfs.translatePath('special://home/addons/plugin.video.RomyM3U/proxy.dat')
...
mislogos = xbmcvfs.translatePath(os.path.join('special://home/addons/plugin.video.RomyM3U/jpg/'))
...
def cambia_fondo():
    ...
    foto = xbmcvfs.translatePath('special://home/addons/plugin.video.RomyM3U/fondo.jpg')    
...
def main_list(params):
    ...
    plugintools.log("RomyM3U.main_list ")    
    ...
    plugintools.add_item(title='[COLOR aqua]---------------------------[/COLOR]',folder=False, isPlayable=False)   
	
    plugintools.add_item(title='[COLOR deeppink]RomyTVm3u[/COLOR]',folder=False, isPlayable=False)
	
    plugintools.add_item(title='[COLOR white]...doar un script...[/COLOR]',folder=False, isPlayable=False)
...
def macpastebin(params):
    ...
    plugintools.log("RomyM3U.macpastebin")    
...
def m3u(params):
    ...
    plugintools.add_item( action="listam3u1", title="[COLOR orange]M3U IptvCat HD[/COLOR]", thumbnail = thmb_ver_m3u, fanart= backgr,page="",url="http://tvkodi.tk/iptv/index.php?country=Romania&search=HD",folder=True )
    if listam3u!='':
...
def mundotv(params): 
    plugintools.log("RomyM3U.mundotv")
    thumbnail = params.get("thumbnail")    
    url3 = params.get("url")    
    s = ''
    def macs(s):
...
def multilistas_mundo(params): 
    plugintools.log("RomyM3U.multilistas_mundo")
    thumbnail = params.get("thumbnail")    
...
def multilistas(params): 
    plugintools.log("RomyM3U.adictos ")
    thumbnail = params.get("thumbnail")    
    url = params.get("url")    
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
...
def multilistas2(params): 
    plugintools.log("RomyM3U.multilistas2")
    thumbnail = params.get("thumbnail")    
    url3 = params.get("url")
    request_headers=[]
    request_headers.append(["User-Agent","Mozilla/5.0 (Windows NT 10.0; rv:75.0) Gecko/20100101 Firefox/75.0"])
...
def tvonline(params): 
    plugintools.log("RomyM3U.tvonline")
    thumbnail = params.get("thumbnail")    
    url = params.get("url")
...
def tvonline2(params): 
    plugintools.log("RomyM3U.tvonline2")
    thumbnail = params.get("thumbnail") 
...
def listam3u1(params): 
    plugintools.log("RomyM3U.listam3u1")
    thumbnail = params.get("thumbnail")    
...
def listam3u2(params): 
    plugintools.log("RomyM3U.listam3u2")
    thumbnail = params.get("thumbnail")    
...
def fluxus (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("RomyM3U.fluxus")
...
def fluxus1 (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("RomyM3U.fluxus1")
...
def sphinx (params):
    thumbnail = params.get("thumbnail")    
    plugintools.log("RomyM3U.sphinx")
...
def sphinxm3u(params): 
    plugintools.log("RomyM3U.sphinxm3u")
    thumbnail = params.get("thumbnail")    
...
def listamd(params): 
    plugintools.log("RomyM3U.listamd")
    thumbnail = params.get("thumbnail")    
...
def radio(params):
    plugintools.add_item( action = "radio_romania" , title = "[COLOR orange]Radio Romania[/COLOR]", thumbnail=thmb_radio, fanart= fnrt_radio,  folder = True ) 
...
def listaace(params): 
    plugintools.log("RomyM3U.listaace")
    thumbnail = params.get("thumbnail")    
...
def listaace2(params): 
    plugintools.log("RomyM3U.listaace2")
    thumbnail = params.get("thumbnail")    
...
def En_Directo(params): 
    plugintools.log("RomyM3U.directo")
    thumbnail = params.get("thumbnail")    
...
def ytfilme(params): 
    plugintools.log("RomyM3U.ytfilme")
    thumbnail = params.get("thumbnail")    
